 ...
 */
import java.util.*;
public class PrimeandPalindrome extends Thread{
    static int n;
    public static void main(String args[]) {
        Scanner sc=new Scanner(System.in);
        System.out.println("Enter the number till which you want to print primes and composites: ");
        int n=sc.nextInt();
         ThreadA a = new ThreadA(n); //For prime numbers
         ThreadB b = new ThreadB(n); //For Composite numbers
